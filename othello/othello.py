...
#Tkinter setup
root = Tk()
screen = Canvas(root, width=500, height=600, background="#255",highlightthickness=0)
screen.pack()
			...
			for y in range(8):
				if self.player == 0:
					if valid(self.array,self.player,x,y):
						screen.create_oval(68+50*x,68+50*y,32+50*(x+1),32+50*(y+1),tags="highlight",fill="blue",outline="white")
...
def drawGridBackground(outline=True):
	...
	if outline:
		screen.create_rectangle(50,50,450,450,outline="black",width="5")
	...
	for i in range(7):
		...
		#Horizontal line
		screen.create_line(50,lineShift,450,lineShift,fill="white",width="2")

		#Vertical line
		screen.create_line(lineShift,50,lineShift,450,fill="white",width="2")
...
def create_buttons():
		#Restart button
		#Background/shadow
		#screen.create_rectangle(0,5,50,55,fill="#000000", outline="#000033")
		#screen.create_rectangle(0,0,50,50,fill="#000088", outline="#000088")

		#Arrow
		screen.create_arc(5,5,45,45,fill="#000088", width="4",style="arc",outline="yellow",extent=300)
		screen.create_polygon(33,38,36,45,40,39,fill="yellow",outline="yellow",width="5")
		...
		#"X"
		screen.create_line(455,5,495,45,fill="red",width="3")
		screen.create_line(495,5,455,45,fill="red",width="3")
	
def runGame():
	global running
	running = False
	#Title and shadow
	screen.create_text(250,205,anchor="c",text="OTHELLO",font=("Consolas", 50),fill="black")
	screen.create_text(250,200,anchor="c",text="OTHELLO",font=("Consolas", 50),fill="#fff")
	
	#Creating the difficulty buttons
	for i in range(3):
		#Background
		screen.create_rectangle(25+155*i, 310, 150+155*i, 355, fill="#000", outline="#000")
		screen.create_rectangle(25+155*i, 300, 150+155*i, 350, fill="#111", outline="#111")
